...
{
    public partial class ModalChapterAttachments
    {
        ...
        [Inject]
        ILogger<ModalChapterAttachments> Logger {get; set;}
        ...
        private async void RemoveAttachment()
        {
            try
            {
                ...
                await CompanyDbAccess.SaveSmartFlowRecord(_SelectedChapterObject, UserSession);
            ...
            {
                GenericErrorLog(true,e, "RemoveAttachment", e.Message);
            }
            finally
            {
                Close();
        ...
        private void GenericErrorLog(bool showNotificationMsg, Exception e, string _method, string _message)
        {
            ...
            using (LogContext.PushProperty("SourceContext", nameof(ModalChapterAttachments)))
            {
