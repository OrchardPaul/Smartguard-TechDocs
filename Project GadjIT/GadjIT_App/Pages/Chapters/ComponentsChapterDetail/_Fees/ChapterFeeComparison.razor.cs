...
namespace GadjIT_App.Pages.Chapters.ComponentsChapterDetail._Fees
{
    public partial class ChapterFeeComparison
    {
        ...
        private async Task SyncItem()
        {
            ...
            var taskObject = _AltChapter.Fees.Where(C => C.FeeName == _Object.FeeObject.FeeName).SingleOrDefault();

            _AltChapter.Fees.Remove(taskObject);
            _AltChapter.Fees.Add(_Object.FeeObject);
