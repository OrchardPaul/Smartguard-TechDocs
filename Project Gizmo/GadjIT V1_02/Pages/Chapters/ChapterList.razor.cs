            ...
            if (selectedChapter.P4WCaseTypeGroup == "Entity Documents")
            {
                ChapterP4WStep = new ChapterP4WStepSchema
                {
                    ...
                    Answers = new List<ChapterP4WStepAnswer>{
                                    ...
                                    ,new ChapterP4WStepAnswer {QNo = 3, GoToData= $"4 [SQL: EXEC up_ORSF_GetStepsFromList '[matters.entityref]', 0] [SQL: UPDATE Usr_ORSF_ENT_Control SET Screen_Opened_Via_Step = null WHERE EntityRef='[matters.entityref]']" }
