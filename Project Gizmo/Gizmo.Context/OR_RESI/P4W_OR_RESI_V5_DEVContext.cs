...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<CaseTypes>(entity =>
            {
                ...
                entity.Property(e => e.CmportalType).HasColumnName("CMPortalType");

                entity.Property(e => e.CodeName)
                    .HasMaxLength(5)
                    .IsUnicode(false);

                entity.Property(e => e.ComplianceCentre)
                    .IsRequired()
                    .HasDefaultValueSql("((1))");

                entity.Property(e => e.ComplianceHighValue)
                    .HasColumnType("money")
                    .HasDefaultValueSql("((0.00))");

                entity.Property(e => e.DefaultDestroyYears).HasDefaultValueSql("(0)");

                entity.Property(e => e.DefaultPasagenda)
                    .HasColumnName("DefaultPASAgenda")
                    .HasMaxLength(50)
                    .IsUnicode(false);

                entity.Property(e => e.DefaultUtbmsbudgetLevel).HasColumnName("DefaultUTBMSBudgetLevel");
                ...
                entity.Property(e => e.DefaultUtbmsphaseTemplateId).HasColumnName("DefaultUTBMSPhaseTemplateID");

                entity.Property(e => e.DefaultUtbmstaskTemplateId).HasColumnName("DefaultUTBMSTaskTemplateID");

                entity.Property(e => e.Description)
                    .HasMaxLength(50)
                    .IsUnicode(false);

                entity.Property(e => e.EnableSdlt).HasColumnName("EnableSDLT");

                entity.Property(e => e.EnableUtbmscoding).HasColumnName("EnableUTBMSCoding");

                entity.Property(e => e.Inactive).HasDefaultValueSql("(0)");

                entity.Property(e => e.InitialAgendaName)
                    .HasMaxLength(50)
                    .IsUnicode(false);

                entity.Property(e => e.IsokonCaseType)
                    .HasMaxLength(25)
                    .IsUnicode(false);

                entity.Property(e => e.MaxConsequenceRating)
                    .HasColumnName("max_consequence_rating")
                    .HasDefaultValueSql("(0)");

                entity.Property(e => e.Mpview)
                    .HasColumnName("MPView")
                    .HasMaxLength(255)
                    .IsUnicode(false);

                entity.Property(e => e.NetDocsSync)
                    .IsRequired()
                    .HasDefaultValueSql("((1))");

                entity.Property(e => e.NextFileNumber).HasDefaultValueSql("(1)");

                entity.Property(e => e.Samallowed)
            ...
            modelBuilder.Entity<DmDocuments>(entity =>
            {
                ...
                entity.ToTable("Dm_Documents");

                entity.Property(e => e.Actioned)
                    .IsRequired()
                    .HasDefaultValueSql("(0)");

                entity.Property(e => e.AlwaysSpecial)
                    .IsRequired()
                    .HasDefaultValueSql("(0)");
                ...
                entity.Property(e => e.CreatedByRef)
                    .HasMaxLength(12)
                    .IsUnicode(false);
                ...
                entity.Property(e => e.DefaultProgressFile)
                    .HasMaxLength(100)
                    .IsUnicode(false);

                entity.Property(e => e.Deleteble)
                    .IsRequired()
                    .HasDefaultValueSql("(1)");
                ...
                entity.Property(e => e.FeeDiaryText)
                    .HasMaxLength(50)
                    .IsUnicode(false);
                ...
                entity.Property(e => e.InstDiaryText)
                    .HasMaxLength(50)
                    .IsUnicode(false);
                ...
                entity.Property(e => e.PartDiaryText)
                    .HasMaxLength(50)
                    .IsUnicode(false);

                entity.Property(e => e.PdfhtmlemailTemplate)
                    .HasColumnName("PDFHTMLEmailTemplate")
                    .HasDefaultValueSql("((-1))");

                entity.Property(e => e.PdfstationerySetId)
                ...
                entity.Property(e => e.Samaction)
                    .HasColumnName("SAMAction")
                    .HasDefaultValueSql("(0)");

                entity.Property(e => e.Sammacro)
                    .HasColumnName("SAMMacro")
                    .HasDefaultValueSql("(0)");

                entity.Property(e => e.Sampriority)
                ...
                entity.Property(e => e.SupDiaryText)
                    .HasMaxLength(50)
                    .IsUnicode(false);

                entity.Property(e => e.TakeToPdf).HasColumnName("TakeToPDF");
            ...
            modelBuilder.Entity<DmDocumentsPermissions>(entity =>
            {
                ...
                entity.ToTable("DM_DocumentsPermissions");

                entity.Property(e => e.Doccode).HasColumnName("doccode");
            ...
            modelBuilder.Entity<UsrOrResiMtFees>(entity =>
            {
                ...
                entity.ToTable("Usr_OR_RESI_MT_Fees");
                ...
                entity.Property(e => e.AllocatedFunds).HasColumnType("datetime");
                ...
                entity.Property(e => e.FeeTypeGroup)
                    .HasMaxLength(255)
                    .IsUnicode(false);
                ...
                entity.Property(e => e.PrintSlipYn)
                    .HasColumnName("Print_Slip_YN")
                    .HasMaxLength(1)
                    .IsUnicode(false);

                entity.Property(e => e.ReconcileId).HasColumnName("ReconcileID");

                entity.Property(e => e.ReconcileTable)
                    .HasMaxLength(40)
                    .IsUnicode(false);

                entity.Property(e => e.Requested).HasColumnType("datetime");

                entity.Property(e => e.SlipPrintStatus)
                    .HasColumnName("Slip_Print_Status")
                    .HasMaxLength(50)
                    .IsUnicode(false);
