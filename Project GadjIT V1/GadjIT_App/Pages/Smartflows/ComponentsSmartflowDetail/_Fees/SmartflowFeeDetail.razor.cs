...
{
    public partial class SmartflowFeeDetail
    {

        [Parameter]
        public List<VmSmartflowFee> _LstFees { get; set; } 
        ...
        [Inject]
        private ILogger<SmartflowFeeDetail> Logger { get; set; }
        ...
        public List<VmSmartflowFee> LstAltSystemItems { get; set; } 

        public VmSmartflowFee EditObject = new VmSmartflowFee { FeeObject = new SmartflowFee() };
        ...
        protected void PrepareForInsert ()
        {
            try
            {
                EditObject = new VmSmartflowFee{FeeObject = new SmartflowFee()};
        ...
        protected void PrepareForEdit(VmSmartflowFee _selectedObject)
        {
            EditObject = _selectedObject;

            ShowSmartflowFeesModal("Edit");

        } 
        

        protected void ShowSmartflowFeesModal(string _option) 
        {
            try
            {
                ...
                SmartflowFee copyObject = new SmartflowFee { 
                ...
                Modal.Show<ModalSmartflowFee>("Fees", parameters, options);
            }
            catch(Exception e)
            {
        ...
        protected void ShowSmartflowFeesViewModal(VmSmartflowFee _selectedObject)//moved partial
        {
            try
            {
                ...
                Modal.Show<ModalSmartflowFeeView>("Fees", parameters, options);
            }
            catch(Exception e)
            {
        ...
        protected void ShowSmartflowFeesDelete(VmSmartflowFee _SelectedSmartflowItem) 
        {
            EditObject = _SelectedSmartflowItem;

            string itemName = _SelectedSmartflowItem.FeeObject.FeeName;
            string itemType = "Fee";
            ...
            try
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        var cItems = AltSmartflow.Fees;

                        LstAltSystemItems = cItems.Select(T => new VmSmartflowFee { FeeObject = T, Compared = false }).ToList();
        ...
        private async Task SyncChapter()
        {
            try
            {
                AltSmartflow.Fees.Clear();
                
                AltSmartflow.Fees.AddRange(_SelectedSmartflow.Fees.ToList());
        ...
        protected void ShowSmartflowComparisonModal(VmSmartflowFee _selectedItem) 
        {
            try
            {
                ...
                Modal.Show<SmartflowFeeComparison>("Synchronise Smartflow Item", parameters, options);
            }
            catch(Exception e)
            {
        ...
        protected void ShowSmartflowDeleteAlt(VmSmartflowFee _selectedItem)
        {
            try
            {
                EditObject = _selectedItem;
                ...
                Modal.Show<ModalSmartflowDetailDelete>($"Delete Fee", parameters, options);
            }
            catch(Exception e)
            {
        ...
        private async Task DeleteAltItem()
        {
            ...
            AltSmartflow.Fees.Remove(EditObject.FeeObject);
        ...
        protected async Task MoveSeq(SmartflowFee _selectobject, string _direction)
        {
            try
            {
        ...
        private async void GenericErrorLog(bool _showNotificationMsg, Exception e, string _method, string _message)
        {
            ...
            using (LogContext.PushProperty("SourceContext", nameof(SmartflowFeeDetail)))
            {
