...
{
    public partial class VmSmartflowDataView
    {
        public SmartflowDataView DataView { get; set; }

        public SmartflowDataView AltDataView { get; set; }
        ...
        public bool IsChapterItemMatch(VmSmartflowDataView dataItem)
        {
