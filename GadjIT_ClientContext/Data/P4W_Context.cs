...
namespace GadjIT_ClientContext.Data
{
    public partial class P4W_Context : DbContext
    {
        ...
        public virtual DbSet<P4W_CaseTypeGroups> CaseTypeGroups { get; set; }
        public virtual DbSet<P4W_CaseTypes> CaseTypes { get; set; }
        public virtual DbSet<P4W_DmDocuments> DmDocuments { get; set; }
        public virtual DbSet<P4W_DmDocumentsPermissions> DmDocumentsPermissions { get; set; }
        public virtual DbSet<P4W_MpSysViews> MpSysViews { get; set; }
        public virtual DbSet<Client_SmartflowRecord> Client_SmartflowRecord { get; set; }
        ...
        public IQueryable<P4W_TableDate> GetTableDates() =>
                Set<P4W_TableDate>().FromSqlInterpolated($"SELECT t.InternalName + '.' + f.InternalFieldName TableField, T.Type TableType FROM Mp_Sys_FieldDef f INNER JOIN Mp_Sys_TableDef t on f.TableRef = t.ID WHERE SQLTypeRef = 91 AND MaxRecords = 1 ORDER BY TableField");
...
//         }
        ...
        {
            modelBuilder.Entity<P4W_TableDate>().HasNoKey().ToView(null);
            modelBuilder.Entity<P4W_TableDate>().ToTable(nameof(P4W_TableDate), t => t.ExcludeFromMigrations());


            modelBuilder.Entity<P4W_CaseTypeGroups>(entity =>
            {
            ...
            modelBuilder.Entity<P4W_CaseTypes>(entity =>
            {
            ...
            modelBuilder.Entity<P4W_DmDocuments>(entity =>
            {
                entity.HasKey(e => e.Code)
                    .IsClustered(false);
            ...
            modelBuilder.Entity<P4W_DmDocumentsPermissions>(entity =>
            {
                entity.HasKey(e => new { e.Doccode, e.Casetype })
                    .HasName("PK__DM_DocumentsPerm__1F7A4DDE");
            });

            modelBuilder.Entity<P4W_MpSysViews>(entity =>
            {
                entity.HasKey(e => e.Id)
                    .IsClustered(false);
            ...
            modelBuilder.Entity<Client_SmartflowRecord>(entity =>
            {
                entity.HasKey(e => e.Id)
                    .IsClustered(false);
